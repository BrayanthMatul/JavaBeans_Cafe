 ...
 * @author matul
 */
public class InternalListaInsumos extends javax.swing.JInternalFrame {

    private InsumoDAO insumoDAO;
    private List<Insumo> insumos;

    /**
     * Creates new form InternalListaInsumos
     */
    public InternalListaInsumos() {
        initComponents();
    ...
    private void cargarInsumos() {
        try {
            this.insumos = insumoDAO.obtenerTodos();
    ...
    private void initComponents() {
        ...
        jLabelTituloLista.setText("Lista de Insumos");
